...
<div class="card rounded-2 border-0 p-4 p-md-5 shadow-none">
    <form class="mx-md-5" name="mahasiswa" method="POST" onsubmit = "return simpan()">
        <div class="mb-3 row">
            ...
            <div class="col-sm-8 col-lg-9">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="txNIM" placeholder="Masukkan NIM" required>
                </div>
            </div>
        </div>   
    ...
    <script src="mhs-adddata.js"></script>
...
<?php
    include_once("../server/mhs-showjurusan.php");
?>