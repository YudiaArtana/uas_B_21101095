...
function update(){
    ...
    let kdlama = document.getElementById("txKDLAMA").value;
    let kd = document.getElementById("txKD").value;
    ...
    let data = "kdlama="+kdlama+"&kd="+kd+"&nama="+nama+"&sks="+sks+"&smt="+smt;
    console.log(data);

    const jsonData = new XMLHttpRequest();
    jsonData.open("POST","../server/mk-dataupdate.php");
