...
<script>
    ...
    jsonData.open("GET","../server/krs-datalist.php")
    jsonData.send()
    ...
    jsonData.onload = function(){
        ...
        hasil += "   <div>"
        hasil += "        <h4 class='my-sm-4 my-2 mx-3'>Daftar Data KRS</h4>"
        hasil += "    </div>"
        ...
        hasil += "            <li class='breadcrumb-item active' aria-current='page'>Data KRS</li>"
        hasil += "        </ol>"
        hasil += "    </div>"
        hasil += "</div>"
        ...
        hasil += "      <a class='btn btn-primary' href='index.php?p=krs&act=add'><b class='px-2 py-1'>Tambah Data</b></a>"
        hasil += "  </div>"
        ...
        hasil += "              <th scope='col'class='py-3'>Nama Matkul</th>"
        hasil += "              <th scope='col'class='py-3'>SKS</th>"
        hasil += "              <th scope='col'class='py-3'>Semester</th>"
        hasil += "              <th scope='col'class='py-3'>Pengajar</th>"
        hasil += "              <th scope='col'class='py-3'>Kelas</th>"
        hasil += "              <th scope='col'class='py-3'>Jam Perkuliahan</th>"
        ...
        for(i=0; i<myData.length; i++){
            ...
            hasil += "  <td>"+myData[i][8]+"</td>"
            hasil += "  <td>"+myData[i][9]+"</td>"
            hasil += "  <td>"+myData[i][11]+"</td>"
            hasil += "  <td>"+myData[i][3]+"</td>"
            hasil += "  <td>"+myData[i][4]+' - '+myData[i][5]+"</td>"
            hasil += "  <td class='text-center'><a class='badge bg-success px-3 py-1' href='index.php?p=krs&act=update&id="+myData[i][0]+"'>EDIT</a><a class='badge bg-danger py-1' href='index.php?p=krs&act=delete&id="+myData[i][0]+"'>HAPUS</a></td>"
            hasil += "</tr>"
