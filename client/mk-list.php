...
<script>
    ...
    jsonData.open("GET","../server/mk-datalist.php")
    jsonData.send()
    ...
    jsonData.onload = function(){
        ...
        hasil += "   <div>"
        hasil += "        <h4 class='my-sm-4 my-2 mx-3'>Daftar Data Mata Kuliah</h4>"
        hasil += "    </div>"
        ...
        hasil += "            <li class='breadcrumb-item active' aria-current='page'>Data Mata Kuliah</li>"
        hasil += "        </ol>"
        hasil += "    </div>"
        hasil += "</div>"
        ...
        hasil += "      <a class='btn btn-primary' href='index.php?p=mk&act=add'><b class='px-2 py-1'>Tambah Data</b></a>"
        hasil += "  </div>"
        ...
        hasil += "              <th scope='col'class='py-3'>Kode</th>"
        hasil += "              <th scope='col'class='py-3'>Nama Matkul</th>"
        hasil += "              <th scope='col'class='py-3'>Jumlah SKS</th>"
        ...
        for(i=0; i<myData.length; i++){
            ...
            hasil += "  <td class='text-center'><a class='badge bg-success px-3 py-1' href='index.php?p=mk&act=update&kd="+myData[i][0]+"'>EDIT</a><a class='badge bg-danger py-1' href='index.php?p=mk&act=delete&kd="+myData[i][0]+"'>HAPUS</a></td>"
            hasil += "</tr>"
